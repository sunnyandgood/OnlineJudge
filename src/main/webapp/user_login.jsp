            ...
            <div class="logo_box">
                ...
                <form action="#" name="f" method="post">
                    <div class="input_outer">
                        ...
                        <input name="nuserNumber" class="text" style="color: #FFFFFF !important" type="text" placeholder="请输入账户">
                    </div>
                    <div class="input_outer">
...
<script>
    function login() {
        $.post('${ctx}/user/login',$('form').serialize(),function (r) {
            if(r.code==200){
                window.location.href="${ctx}/page/userIndex";
            }else {
                // layer.msg(r.message);
                alert(r.message);
            }
